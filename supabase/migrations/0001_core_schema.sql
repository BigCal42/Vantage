-- Migration: Core schema for Vantage Mission Control
...
create policy if not exists "Allow all operations" on public.projects for all using (true);
create policy if not exists "Allow all operations" on public.health_metrics for all using (true);
create policy if not exists "Allow all operations" on public.risks for all using (true);
create policy if not exists "Allow all operations" on public.decisions for all using (true);
create policy if not exists "Allow all operations" on public.stakeholders for all using (true);
create policy if not exists "Allow all operations" on public.briefings for all using (true);
create policy if not exists "Allow all operations" on public.actions for all using (true);
...
create index if not exists idx_health_metrics_project_id on public.health_metrics(project_id);
